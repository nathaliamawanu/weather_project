...
let weatherAPIKey = '3dd3c5d1e9a0eb4e87e38f3a0d731d74';
let weatherBaseEndpoint = 'https://api.openweathermap.org/data/2.5/weather?units=metric&appid=' + weatherAPIKey;
let forecastBaseEndpoint = 'https://api.openweathermap.org/data/2.5/forecast?units=metric&appid&appid=' + weatherAPIKey;
...
let weatherImages = [
    ...
    },
    {
        ...
        ids: [520, 521, 522, 531, 300, 301, 302, 310, 311, 312, 313,
            314, 321]
    },
    {
        url: 'images/snow.png',
        ids: [511, 600, 601, 602, 611, 612, 613, 615, 616, 620, 621,
            622]
    },
    {
...
searchInp.addEventListener('input', async () => {
    ...
    let cities = result._embeded['city:search-results'];
...
let updateCurrentWeather = (data) => {
    ...
    temperature.textContent = data.main.tem > 0 ?
    ...
    forecast.forEach(day => {
        ...
        let forecastItem = `
            <article class="weather_forecast_item">
                    <img src="${iconUrl}" alt="${day.weather[0].description}" class="weather_foreccast_icon">
